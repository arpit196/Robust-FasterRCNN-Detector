...
class Dataset:
  ...
  def __init__(self, split, dir = "C:\\Users\\arpit.rai\\Notebooks\\VOC\\VOC2007\\VOCtrainval_06-Nov-2007\\VOCdevkit\\VOC2007", feature_pixels = 16, augment = True, shuffle = True, allow_difficult = False, cache = True,noise='none'):
    """
    Parameters
    ----------
    split : str
